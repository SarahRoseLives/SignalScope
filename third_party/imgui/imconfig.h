...
// SignalScope: enabled. Large FFTs (32768/65536 bins) make ImPlot emit >64K
// vertices in a single PlotLine mesh. With 16-bit indices and a GL 3.0 context
// (VtxOffset unsupported < GL 3.2) the indices wrap and the spectrum flickers.
// This was Windows-only because Linux drivers hand back a >=3.2 context by
// default. The GL3 backend already selects GL_UNSIGNED_INT from sizeof(ImDrawIdx).
